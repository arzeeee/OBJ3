 ...
 */
package animalController.kalkunController;
 ...
 * @author Aya Aurora
 */
public class KalkunController{
    private Kalkun model;
    private KalkunView view;
    
    public KalkunController(Kalkun model, KalkunView view) {
        this.model = model;
        this.view = view;
    }
    
    public Kalkun getModel() {
        return model;
    }
    ...
    //Setter Chicken
    public void setModel(Kalkun model) {
        this.model = model;
    }
    ...
    //Setter ChickenView
    public void setView(KalkunView view) {
        this.view = view;
    }
    ...
    public void move() {
        //generate random movement
            ...
            if (model.getDirection() == 1) {
                view.loadImage("./img/kalkun/kalkun" + "down.png");
                view.getImageDimensions();
            }
        
            if (model.getDirection() == 2) {
                view.loadImage("./img/kalkun/kalkun" + "right.png");
                view.getImageDimensions();
            }
        
            if (model.getDirection() == 3) {
                view.loadImage("./img/kalkun/kalkun" + "up.png");
                view.getImageDimensions();
            }
        
            if (model.getDirection() == 4) {
                view.loadImage("./img/kalkun/kalkun" + "left.png");
                view.getImageDimensions();
            }
