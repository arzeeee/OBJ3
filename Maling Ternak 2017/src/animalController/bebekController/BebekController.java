 ...
 */
package animalController.bebekController;
    ...
    public void move() {
        //generate random movement
            ...
            if (model.getDirection() == 1) {
                view.loadImage("./img/bebek/bebek" + "down.png");
                view.getImageDimensions();
            }
        
            if (model.getDirection() == 2) {
                view.loadImage("./img/bebek/bebek" + "right.png");
                view.getImageDimensions();
            }
        
            if (model.getDirection() == 3) {
                view.loadImage("./img/bebek/bebek" + "up.png");
                view.getImageDimensions();
            }
        
            if (model.getDirection() == 4) {
                view.loadImage("./img/bebek/bebek" + "left.png");
                view.getImageDimensions();
            }
